package com.laogeli.gateway.service;
...
import com.laogeli.gateway.mapper.RouteMapper;
import com.laogeli.gateway.module.Route;
import com.laogeli.gateway.vo.RouteFilterVo;
import com.laogeli.gateway.vo.RoutePredicateVo;
...
public class RouteService extends CrudService<RouteMapper, Route> {
    ...
    public int insert(Route route) {
        ...
        route.setCommonValue("", GatewayConstant.SYS_CODE);
